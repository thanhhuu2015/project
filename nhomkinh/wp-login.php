...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	<div class="_wrapper_login">

	<div class="_left_login">
		<img src="<?php bloginfo( 'url' ); ?>/wp-content/themes/vdigi/assets/images/img-01.webp" alt="">
	</div>

    <div class="_right_login">
	...
	default:
		...
		<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
			<p>
				...
				<input type="text" name="log" id="user_login"<?php echo $aria_describedby_error; ?> class="input" value="<?php echo esc_attr( $user_login ); ?>" size="20" autocapitalize="off" placeholder="Username" />
			</p>
			...
			<div class="user-pass-wrap">
				...
				<div class="wp-pwd">
					...
					<input type="password" name="pwd" id="user_pass"<?php echo $aria_describedby_error; ?> class="input password-input" value="" size="20" placeholder="Password"/>
