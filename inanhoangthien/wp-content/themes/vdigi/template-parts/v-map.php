            ...
            <script>
                function initialize() {
                    ...
                    var infowindow = new google.maps.InfoWindow({
                        content: '<div class="content-map"><img src="<?php echo $company_logo; ?>" alt="map"><div class="copy"><p><strong><?php echo $company_name; ?></strong><br/><?php echo $company_address; ?></p></div></div>'
                    });
